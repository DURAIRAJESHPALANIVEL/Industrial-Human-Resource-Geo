...
# Load dataset
df = pd.read_csv(r"C:\Users\durai\structured_classified.csv")
...
# Sidebar Filters
state_filter = st.sidebar.selectbox("Select State", sorted(df['India/States'].dropna().unique()))
...
filtered_data = df[(df['India/States'] == state_filter) & (df['Industry Classification'] == industry_filter)]
